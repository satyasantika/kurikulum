...
<form id="formAction" action="{{ $prodi->id ? route('prodis.update',$prodi->id) : route('prodis.store') }}" method="post">
    ...
    <div class="card-body">
        {{-- kode UNSIL --}}
        <div class="row mb-3">
            <label for="kode_unsil" class="col-md-4 col-form-label text-md-end">Kode UNSIL</label>
            <div class="col-md-8">
        ...
        {{-- kode Prodi --}}
        <div class="row mb-3">
            <label for="kode_prodi" class="col-md-4 col-form-label text-md-end">Kode PDDIKTI</label>
            <div class="col-md-8">
        ...
        {{-- visi_misi --}}
        <div class="row mb-3">
            <label for="visi_misi" class="col-md-4 col-form-label text-md-end">Visi</label>
            <div class="col-md-8">
                <textarea name="visi_misi" rows="3" class="form-control" id="visi_misi">{{ $prodi->visi_misi }}</textarea>
            </div>
        </div>
        {{-- jenjang --}}
        <div class="row mb-3">
        ...
        {{-- no_telepon --}}
        <div class="row mb-3">
            <label for="no_telepon" class="col-md-4 col-form-label text-md-end">no_telepon</label>
            <div class="col-md-8">
        ...
        {{-- tahun pendirian --}}
        <div class="row mb-3">
            <label for="tahun_pendirian" class="col-md-4 col-form-label text-md-end">tahun_pendirian</label>
            <div class="col-md-8">
        ...
        {{-- sk pendirian --}}
        <div class="row mb-3">
            <label for="sk_pendirian" class="col-md-4 col-form-label text-md-end">sk_pendirian</label>
            <div class="col-md-8">
        ...
        {{-- tahun akreditasi --}}
        <div class="row mb-3">
            <label for="tahun_akreditasi" class="col-md-4 col-form-label text-md-end">tahun_akreditasi</label>
            <div class="col-md-8">
        ...
        {{-- sk akreditasi --}}
        <div class="row mb-3">
            <label for="sk_akreditasi" class="col-md-4 col-form-label text-md-end">sk_akreditasi</label>
            <div class="col-md-8">
        ...
        {{-- tahun internasional --}}
        <div class="row mb-3">
            <label for="tahun_internasional" class="col-md-4 col-form-label text-md-end">tahun_internasional</label>
            <div class="col-md-8">
        ...
        {{-- sk internasional --}}
        <div class="row mb-3">
            <label for="sk_internasional" class="col-md-4 col-form-label text-md-end">sk_internasional</label>
            <div class="col-md-8">
...
@if ($prodi->id)
<form id="formReset" action="{{ route('mypassword.reset',$prodi->id) }}" method="POST" class="d-none">
    @csrf
</form>
@endif
@if ($prodi->id)
